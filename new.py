...
github_repo = "testgit"
access_token = "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"
branch_name = 'master'
new_branch = 'restoremaster15'
...
# tree_sha = response.json().get("object", {}).get("sha")
...
# commit_sha = response.json().get("object", {}).get("sha")
